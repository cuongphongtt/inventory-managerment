				...
				<div class="x_content">
					<div class="container">
						<form:form modelAttribute="searchForm"
							...
							servletRelativeAction="/product-in-stock/list/1" method="GET">
							...
							<div class="form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12"
									for="productInfo.name">Name </label>
								<div class="col-md-6 col-sm-6 col-xs-12">
									<form:input path="productInfo.name"
										cssClass="form-control col-md-7 col-xs-12" />
								</div>
							</div>
							<div class="form-group">
								<label for="productInfo.category.name"
						...
						<table class="table table-striped jambo_table bulk_action">
							...
							<tbody>
								<c:forEach items="${products}" var="product" varStatus="loop">
									...
									<td class=" "><img src="<c:url value="${product.productInfo.imgUrl}"/>" width="70px" height="100px"/></td>
