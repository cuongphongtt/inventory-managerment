...
public class ProductInfo implements java.io.Serializable {
	...
	public ProductInfo(Category category, String name, String code, int activeFlag, Date createDate, Date updateDate) {
	...
	public ProductInfo(Category category, String name, String code, String description, String imgUrl, int activeFlag,
			Date createDate, Date updateDate, Set productInStocks, Set invoices, Set histories) {
		this.category = category;
		this.name = name;
		this.code = code;
